...
bool GraphicsEngine::Init(HWND hWindow) {
	...
	EventResult = RenderTarget->CreateSolidColorBrush(D2D1::ColorF(static_cast<float>(0.0), static_cast<float>(0.5), static_cast<float>(0.7), static_cast<float>(1.0)), &Brush);
...
void GraphicsEngine::DrawEmptyRectangle(double X, double Y, double Width, double Height, double R, double G, double B, double A, double Thickness) {
	Brush->SetColor(D2D1::ColorF(static_cast<float>(R), static_cast<float>(G), static_cast<float>(B), static_cast<float>(A)));
	RenderTarget->DrawRectangle(D2D1::Rect(static_cast<float>(X), static_cast<float>(Y), static_cast<float>(X + Width), static_cast<float>(Y + Height)), Brush, static_cast<float>(abs(Thickness)));
}

void GraphicsEngine::DrawFullRectangle(double X, double Y, double Width, double Height, double R, double G, double B, double A) {
	Brush->SetColor(D2D1::ColorF(static_cast<float>(R), static_cast<float>(G), static_cast<float>(B), static_cast<float>(A)));
	RenderTarget->FillRectangle(D2D1::Rect(static_cast<float>(X), static_cast<float>(Y), static_cast<float>(X + Width), static_cast<float>(Y + Height)), Brush);
}
...
void GraphicsEngine::DrawEmptySquare(double X, double Y, double SideLength, double R, double G, double B, double A, double Thickness) {
	Brush->SetColor(D2D1::ColorF(static_cast<float>(R), static_cast<float>(G), static_cast<float>(B), static_cast<float>(A)));
	RenderTarget->DrawRectangle(D2D1::Rect(static_cast<float>(X), static_cast<float>(Y), static_cast<float>(X + SideLength), static_cast<float>(Y + SideLength)), Brush, static_cast<float>(abs(Thickness)));
}

void GraphicsEngine::DrawFullSquare(double X, double Y, double SideLength, double R, double G, double B, double A) {
	Brush->SetColor(D2D1::ColorF(static_cast<float>(R), static_cast<float>(G), static_cast<float>(B), static_cast<float>(A)));
	RenderTarget->FillRectangle(D2D1::Rect(static_cast<float>(X), static_cast<float>(Y), static_cast<float>(X + SideLength), static_cast<float>(Y + SideLength)), Brush);
}
...
void GraphicsEngine::WriteText(std::string TextIn, std::string FontName, double FontSize, double X, double Y, double Width, double Height, double R, double G, double B, double A) {
	...
	RenderTarget->DrawText((StringToWstring(TextIn)).c_str(), TextIn.size(), TextFormat, D2D1::Rect(static_cast<float>(X), static_cast<float>(Y), static_cast<float>(X + Width), static_cast<float>(Y + Height)), Brush ,D2D1_DRAW_TEXT_OPTIONS_NONE,DWRITE_MEASURING_MODE_NATURAL);
}